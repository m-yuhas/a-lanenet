...
class InitialBlock(pytorch_lightning.LightningModule):
...
class BottleneckModule(pytorch_lightning.LightningModule):
...
class ENet_Encoder(pytorch_lightning.LightningModule):
    ...
    def __init__(self, in_ch=3, dropout_prob=0):
        ...
        self.dq3 = torch.quantization.QuantStub()
...
class ENet_EncoderBlock2(pytorch_lightning.LightningModule):
    
    def __init__(self, base_model):
        super(ENet_EncoderBlock2, self).__init__()
        ...
        # Encoder
        self.q0 = base_model.q0
        self.initial_block = base_model.initial_block
        self.dq0 = base_model.dq0

        self.q1 = base_model.q1
        self.bottleneck1_0 = base_model.bottleneck1_0
        self.bottleneck1_1 = base_model.bottleneck1_1
        self.bottleneck1_2 = base_model.bottleneck1_2
        self.bottleneck1_3 = base_model.bottleneck1_3
        self.bottleneck1_4 = base_model.bottleneck1_4
        self.dq1 = base_model.dq1

        self.q2 = base_model.q2
        self.bottleneck2_0 = base_model.bottleneck2_0
        self.bottleneck2_1 = base_model.bottleneck2_1
        self.bottleneck2_2 = base_model.bottleneck2_2
        self.bottleneck2_3 = base_model.bottleneck2_3
        self.bottleneck2_4 = base_model.bottleneck2_4
        self.bottleneck2_5 = base_model.bottleneck2_5
        self.bottleneck2_6 = base_model.bottleneck2_6
        self.bottleneck2_7 = base_model.bottleneck2_7
        self.bottleneck2_8 = base_model.bottleneck2_8
        self.dq2 = base_model.dq2

        self.q3 = base_model.q3
        self.initial_block.freeze()
        self.bottleneck1_0.freeze()
        self.bottleneck1_1.freeze()
        self.bottleneck1_2.freeze()
        self.bottleneck1_3.freeze()
        self.bottleneck1_4.freeze()
        self.bottleneck2_0.freeze()
        self.bottleneck2_1.freeze()
        self.bottleneck2_2.freeze()
        self.bottleneck2_3.freeze()
        self.bottleneck2_4.freeze()
        self.bottleneck2_5.freeze()
        self.bottleneck2_6.freeze()
        self.bottleneck2_7.freeze()
        self.bottleneck2_8.freeze()
        self.dq3 = base_model.dq3
...
class ENet_EncoderBlock1(pytorch_lightning.LightningModule):
    
    def __init__(self, base_model):
        super(ENet_EncoderBlock1, self).__init__()
...
class ENet_EncoderBlock0(pytorch_lightning.LightningModule):
    
    def __init__(self, base_model):
        super(ENet_EncoderBlock0, self).__init__()
...
class ENet_Decoder(pytorch_lightning.LightningModule):
    ...
    def __init__(self, out_ch=1, dropout_prob=0):
        ...
        self.fullconv = nn.Conv2d(16, out_ch, kernel_size=3, stride=1, padding=1)
        self.dq0 = torch.quantization.DeQuantStub()
...
class ENet_DecoderEarlyExit(pytorch_lightning.LightningModule):
    
    def __init__(self, scale_factor=4, in_ch=16, out_ch=1, dropout_prob=0):
        super(ENet_DecoderEarlyExit, self).__init__()

        self.q0 = torch.quantization.QuantStub()
        self.pre_upsample = nn.Upsample(scale_factor=scale_factor / 4, mode='bilinear', align_corners=True)

        #self.bottleneck4_0 = BottleneckModule(128, 64, module_type = 'upsampling', padding = 1, dropout_prob = dropout_prob)
        #self.bottleneck4_1 = BottleneckModule(64, 64, module_type = 'regular', padding = 1, dropout_prob = dropout_prob)
        #self.bottleneck4_2 = BottleneckModule(64, 64, module_type = 'regular', padding = 1, dropout_prob = dropout_prob)

        self.bottleneck5_0 = BottleneckModule(in_ch, 16, module_type = 'upsampling', padding = 1, dropout_prob = dropout_prob)
        self.bottleneck5_1 = BottleneckModule(16, 16, module_type = 'regular', padding = 1, dropout_prob = dropout_prob)
...
class ENet(pytorch_lightning.LightningModule):
